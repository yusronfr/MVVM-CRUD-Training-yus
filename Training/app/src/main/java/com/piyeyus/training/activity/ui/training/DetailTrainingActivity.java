package com.piyeyus.training.activity.ui.training;
...
public class DetailTrainingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(DetailTrainingActivity.this).load(image).error(R.drawable.ic_menu).into(ivImageTrainingDetail);
