package com.piyeyus.training.adapter;
...
import com.piyeyus.training.R;
import com.piyeyus.training.activity.HomeActivity;
import com.piyeyus.training.activity.ui.training.DetailTrainingActivity;
import com.piyeyus.training.helper.Config;
import com.piyeyus.training.model.ResponseErrorModel;
import com.piyeyus.training.model.TrainingModel;
import com.piyeyus.training.rest.ApiConfig;
import com.piyeyus.training.rest.ApiService;
...
public class TrainingAdapter extends RecyclerView.Adapter<TrainingAdapter.TrainingViewHolder> {
        ...
        public void onBindViewHolder(@NonNull TrainingViewHolder holder, int position)
        {
            ...
            Glide.with(context).load(trainingModels.get(position).getGambarTraining()).error(R.drawable.ic_menu).into(holder.ivImageTrainingItem);
                            ...
                            .enqueue(new Callback<ResponseErrorModel>() {
                                ...
                                public void onResponse(Call<ResponseErrorModel> call,
                                    ...
                                    if (response.isSuccessful()){
                                        ...
                                        ((HomeActivity)context).setup();// sek durung iso //oke siap
                                    }
                                }
                                @Override
